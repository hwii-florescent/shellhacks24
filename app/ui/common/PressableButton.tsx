...
const defaultButtonClassnames = {
  ...
  secondary:
    "border-2 border-red-600 w-full items-center px-2 py-2.5 rounded-xl my-2",
...
const defaultTextClassnames = {
  ...
  secondary: "text-red-600 font-semibold text-lg",
  tertiary: "text-red-600 font-semibold text-lg",
};
